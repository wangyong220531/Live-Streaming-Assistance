        ...
        <div className={style["index"]}>
            ...
            <div className={style["right"]}>
                <div className={style["tabs"]}>
                    ...
                    <div className={style[activedTab === 0 ? "activedTab" : "tab"]} onClick={() => tabCLick(0)}>背景</div>
                    <div className={style[activedTab === 1 ? "activedTab" : "tab"]} onClick={() => tabCLick(1)}>车</div>
                    <div className={style[activedTab === 2 ? "activedTab" : "tab"]} onClick={() => tabCLick(2)}>模特</div>
                </div>
                <div className={style["car"]}>
                    {activedTab === 0 && bgs.map(bg => {
                        return <div className={style[activedBg === bg.url ? "activedBg" : "bg"]} onClick={() => handleBgClick(bg)}>
                            <div className={style["wrapper"]}>
                                <img src={bg.url} alt="" />
                            </div>
                        </div>
                    })}
                    {activedTab === 1 && cars.map(car => {
                    ...
                    {activedTab === 2 && models.map((model, index) => {
                        return <div className={style[activedModel === model.url ? "activedModel" : "model"]} onClick={() => handleModelClick(model)}>
                            <div className={style["wrapper"]}>
